                ...
                while ((lineRec = reader.ReadLine()) != null)
                {
                    ...
                    if (txtUser.Text == userName || txtUser.Text == Email)
                    {
                        ...
                        if (txtPass.Text == Password)
                        {
                            ...
                            // Transition logic
                            if (!Reg_Login.User_Select.GlobalSettings.isAdmin && !isAdmin)
                            {
                            ...
                            else if (!Reg_Login.User_Select.GlobalSettings.isAdmin && isAdmin)
                            {
                                MessageBox.Show("This is an Admin account. Log in from the Admin side", "Error");
                            }
                            else if (Reg_Login.User_Select.GlobalSettings.isAdmin)
                            {
                                this.Hide();
